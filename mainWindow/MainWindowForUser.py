...
from mainWindow.dialogWindow import importData, InfoAboutProg, dataBaseUsers
...
class MainWindowUser(QMainWindow):
    ...
    def createActions(self):
        ...
        self.reference = QAction(QIcon("images/about.png"), "О программе")
        self.reference.setShortcut("Ctrl+R")
        self.reference.triggered.connect(self.getDataAboutProgramm)
    ...
    def createMenu(self):
        ...
        reference.addAction(self.reference)
    ...
    def createToolBar(self):
        if self.statusToolbar == True:
            ...
            self.standart_1 = QAction(QIcon("images/tool.png"), "эелемент 1")
            self.standart_2 = QAction(QIcon("images/tool.png"), "эелемент 2")
            self.standart_3 = QAction(QIcon("images/tool.png"), "эелемент 3")
            self.standart_4 = QAction(QIcon("images/tool.png"), "эелемент 4")

            self.toolbar.addAction(self.standart_1)
            self.toolbar.addAction(self.standart_2)
